...
public class Product extends Function implements Iterable<Function> {
	...
	public Function differentiateFunction() throws CloneNotSupportedException {
		...
		if (functions.size() == 0) {
			...
			return functions.get(0).getDerivative();
			...
			Product term1 = ((Product)toBeF0.clone()).multiply(toBeF1.getDerivative());
			Product term2 = ((Product)toBeF1.clone()).multiply(toBeF0.getDerivative());
