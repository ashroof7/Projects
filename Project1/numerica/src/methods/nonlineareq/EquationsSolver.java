...
public class EquationsSolver {
	...
	public static Solution solve(Function f, Map<String, Object> args, int method) throws MethodException, MethodNotSupportedException, ArgumentsException, CloneNotSupportedException {
